	...
	<xsl:template match="/xml">
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                    	...
                    	<form name="addPartida" role="form" action="{$adminroot}?m={$modName}&amp;action=BackEditCosto" method="post">
                    		<input type="hidden" name="redirect" value="{$adminroot}{$modName}{$redirect}" />
                    		<input type="hidden" name="id" value="{$content/costo/id}" />
	                        	...
	                        	<div class="form-group clearfix">
	                        		<div class="row">
	                        			<div class="col-sm-12 col-md-12">
				                            ...
				                            <input type="text" class="form-control" name="title" value="{$content/costo/title}"  />
				                        </div>
	                           			...
	                           			<div class="col-sm-12 col-md-12">
			                        		...
			                        		<div class="input-group m-bot15">
		                                		...
		                                		<input type="text" name="amount" class="form-control" value="{$content/costo/amount}"  />
		                            		</div>
										</div>
